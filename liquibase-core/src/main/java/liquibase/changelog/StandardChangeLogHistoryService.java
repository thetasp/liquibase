...
public class StandardChangeLogHistoryService extends AbstractChangeLogHistoryService {
    ...
    public void init() throws DatabaseException {
        ...
        if (changeLogTable != null) {
            ...
            if (!hasDescription) {
                // Theta: Commented out due to DatabaseUpdateWithDirectoryTask.java new ant task that
                // having the output generated by the looping of ChangeSet at CustomChangeLogIterator.java
                // Without commenting it out, liquibase will hit error on SQL generation
